...
pub struct SchedSample {
    ...
    #[stat(
        desc = "Invariant utilization of this CPU by domain-pinned tasks scaled by CPU capacity and frequency"
    )]
    ...
    #[stat(desc = "Per-CPU warmth (cache/TLB) [0, 1024]")]
    pub cpu_heat: u16,
    #[stat(desc = "CPU the per-CPU warmth belongs to")]
    pub warm_cpu_id: u16,
}
...
impl SchedSample {
    pub fn format_header<W: Write>(w: &mut W) -> Result<()> {
        writeln!(
            w,
            "\x1b[93m| {:6} | {:7} | {:17} | {:5} | {:4} | {:8} | {:8} | {:8} | {:17} | {:8} | {:11} | {:8} | {:7} | {:8} | {:12} | {:12} | {:9} | {:9} | {:9} | {:9} | {:8} | {:8} | {:8} | {:8} | {:9} | {:10} | {:11} | {:9} | {:10} | {:6} | {:6} | {:10} | {:7} | {:6} | {:8} | {:7} | {:6} | {:8} |\x1b[0m",
            "MSEQ",
            "PID",
            "COMM",
            "STAT",
    ...
    pub fn format<W: Write>(&self, w: &mut W) -> Result<()> {
        ...
        writeln!(
            w,
            "| {:6} | {:7} | {:17} | {:5} | {:4} | {:8} | {:8} | {:8} | {:17} | {:8} | {:11} | {:8} | {:7} | {:8} | {:12} | {:12} | {:9} | {:9} | {:9} | {:9} | {:8} | {:8} | {:8} | {:8} | {:9} | {:10} | {:11} | {:9} | {:10} | {:6} | {:6} | {:10} | {:7} | {:6} | {:8} | {:7} | {:6} | {:8} |",
            self.mseq,
            self.pid,
            self.comm,
            self.stat,
